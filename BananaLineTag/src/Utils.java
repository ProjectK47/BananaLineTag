...
public final class Utils {
	...
	/**
	 * Saves an <code>ArrayList</code> of <code>Strings</code> as a plain text file with each String on a different line.
	...
	/**
	 * Attempts to load an <code>Object</code> from a file, returns <code>null</code> if the object failed to load.
	...
	/**
	 * Attempts to read a <code>String</code> from the first line of the given plain text file, returns "" if if fails.
	...
	/**
	 * Attempts to load an <code>ArrayList</code> of <code>String</code> from the given plain text file. Failure results in an empty array.
	...
	/**
	 * Attempts to load a <code>String</code> from a plain text file, combining lines with spaces in between. Returns "" on failure.
	...
	/**
	 * Converts the given <code>String</code> to an <code>int</code>, removing all non-number characters and combining numbers.
	...
	/**
	 * Serializes an Object to an array of bytes, then compresses it.
	 * Like calling Utils.compress(Utils.ser(o))
	 * @param toSer the Object to Serialize
	 * @return the Serialized Object as a byte array
	 */
	...
	/**
	 * Decompresses the given byte array, then deserializes an Object from the result.
	 * Like calling Utils.deser(Utils.decompress(b));
	 * @param b the Object as bytes
	 * @return the Object
	 */
	...
	/**
	 * Converts the given <code>String</code> to an <code>double</code>, removing all non-number characters and combining numbers.
	 * The resulting number then has its decimal point inserted.
	 * Returns 0 if there are no number characters.
	 * @param number the number to convert as a String
	 * @return the number from the String
	 */
	...
	/**
	 * Computes the direction an object would point in to get from <code>(fromx, fromy)</code> to <code>(tox, toy)</code>
	 * @param fromx the start x
	 * @param fromy the start y
	 * @param tox the end x
	 * @param toy the end y
